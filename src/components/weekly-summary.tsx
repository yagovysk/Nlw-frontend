...
export function WeeklySummary({ summary }: WeeklySummaryProps) {
	// Verificar se summary existe e tem dados válidos antes de usá-los
	if (!summary || summary.total === 0) {
		return <div>Nenhuma meta disponível para esta semana.</div>;
	}
			...
			<div className="space-y-6">
				...
				Object.entries(summary.goalsPerDay).length > 0 ? (
					...
					<p className="text-zinc-400">
						Nenhuma meta foi completada nesta semana.
					</p>
				)}
			</div>
		</main>
